/***************************************************************************************************
 * File：IVmGrayMatchVA.h
 * Note：CH: 灰度匹配模块接口声明 | En: Interface for the GrayMatchVA tool.
 *
 * Version：4.3
 * Date: 2021-01-13 14:43:42
 ***************************************************************************************************/
#ifndef _IVM_GRAYMATCHVA_H_
#define _IVM_GRAYMATCHVA_H_
...
namespace VisionMasterSDK
{
    namespace IMVSGrayMatchModuVA
    {
        ...
        typedef enum _MatchingPolarityEnum
        {
            // CH: 不考虑极性 | EN: Ignored
            MatchingPolarity_No = 0x0,

            // CH: 考虑极性 | EN: Considered
            MatchingPolarity_Yes = 0x1,

        }MatchingPolarityEnum;

        /*  Note: Interface Classes of the RoiManager.  */
        class GrayMatchVARoiManager
        {
        public:
        ...
        /*  Note: Interface Classes of the parameter of the GrayMatchVAParams.  */
        class GrayMatchVAParams : public CModuParamsBase
        {
        protected:
            ///< Constructor and Destructor
            explicit GrayMatchVAParams() {}
            virtual ~GrayMatchVAParams() {}
        ...
        public:
            ...
            virtual GrayMatchVARoiManager* GetModuRoiManager() = 0;
            ...
            // CH: 匹配极性 | EN: Match Polarity
            __declspec(property(put = SetPolarity, get = GetPolarity)) int Polarity;

            virtual int GetPolarity() = 0;

            virtual void SetPolarity(int value) = 0;

            // CH: 匹配极性 | EN: Match Polarity
            __declspec(property(put = SetMatchingPolarity, get = GetMatchingPolarity)) MatchingPolarityEnum MatchingPolarity;

            virtual MatchingPolarityEnum GetMatchingPolarity() = 0;

            virtual void SetMatchingPolarity(MatchingPolarityEnum value) = 0;
            ...
            // CH: 匹配结束层 | EN: EndPyramidLevel Feature
            __declspec(property(put = SetEndPyramidLevel, get = GetEndPyramidLevel)) int EndPyramidLevel;

            virtual int GetEndPyramidLevel() = 0;

            virtual void SetEndPyramidLevel(int value) = 0;
        ...
        /*************************** Results Class Start ***************************/
        /*  Note: 灰度模板匹配信息类.  */
        class IGrayMatchVAInfo
        {
        protected:
            ///< 构造与析构函数
            explicit IGrayMatchVAInfo() {}
            virtual ~IGrayMatchVAInfo() {}
        ...
        public:
            ...
            * 只读
            */
            virtual PointF GetMatchPoint() = 0;
            /**
            * @par 说明
            * 匹配得分
            * @par 权限
        ...
        /*  Note: Interface Classes of the result of the GrayMatchVAResults.  */
        class GrayMatchVAResults : public CModuleResultBase
        {
        protected:
            ///< Constructor and Destructor
            explicit GrayMatchVAResults() {}
            virtual ~GrayMatchVAResults() {}
        ...
        public:
            ...
            * 无
            */
            virtual IGrayMatchVAInfo* GetMatchInfo(int nMatchIndex) = 0;
        };
        /*************************** Results Class End ***************************/

        /*************************** Tool Class Start ***************************/
        /*  Note: Note: This is the class for the GrayMatchVA tool.  */
        class IMVSGrayMatchModuVATool : public CVmToolBase
        {
        protected:
            ///< Constructor and Destructor
            explicit IMVSGrayMatchModuVATool() {}
            virtual ~IMVSGrayMatchModuVATool() {}
        ...
        public:
            ...
            * 参数对象，失败返回NULL
             ...
             * 通过参数对象可设置获取模块参数
             */
            virtual GrayMatchVAParams* GetParamObj() = 0;
             ...
             * 只读
             */
            virtual GrayMatchVAResults* GetResult() = 0;
        ...
        private:
            IMVSGrayMatchModuVATool(IMVSGrayMatchModuVATool&);
            IMVSGrayMatchModuVATool& operator=(IMVSGrayMatchModuVATool&);
        };
        /*************************** Tool Class End ***************************/
    }
}
...
/*  Note: Get tool instance for GrayMatchVA.  */
IMVS_6000_PLATFORMSDK_API VisionMasterSDK::IMVSGrayMatchModuVA::IMVSGrayMatchModuVATool * __stdcall GetGrayMatchVAToolInstance(IN const char * const strName);

#ifdef __cplusplus
}
#endif

#endif    ///< _IVM_GRAYMATCHVA_H_
