...
const static int MVD_ALG_STS_ERR_3D_LINE_FIT_FAIL	                      =  0x10000205;	///< ch: 3D直线拟合失败
const static int MVD_ALG_STS_ERR_3D_PLANE_FIT_FAIL	                      =  0x10000206;	///< ch: 3D平面拟合失败
...
//金字塔模板匹配参数
const static int MVD_ALG_STS_ERR_MVBPATMATCH_MODU_PYRAMID_MODEL_DISABLE                = 0x101000B0;      ///< ch: 轮廓特征模型生成模块未使能
const static int MVD_ALG_STS_ERR_MVBPATMATCH_MODU_PYRAMID_MATCH_DISABLE                = 0x101000B1;      ///< ch: 轮廓特征模板匹配查找模块未使能
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MODEL_PYRAMIDSCALE_FLAG     = 0x101000B2;      ///< ch: 轮廓模板模型特征尺度标记参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MODEL_PYRAMIDSCALE_FINE     = 0x101000B3;      ///< ch: 轮廓模板模型精度特征尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MODEL_PYRAMIDSCALE_ROUGH    = 0x101000B4;      ///< ch: 轮廓模板模型速度特征尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MODEL_EDGE_THRESHOLD_FLAG   = 0x101000B5;      ///< ch: 轮廓模板模型边缘阈值标记参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MODEL_EDGE_THRESHOLD        = 0x101000B6;      ///< ch: 轮廓模板模型边缘阈值参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_MIN_SCORE             = 0x101000B7;      ///< ch: 轮廓模板匹配最小匹配分数参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_MAX_MATCH_NUM         = 0x101000B8;      ///< ch: 轮廓模板匹配最大匹配个数参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_POLARITY              = 0x101000B9;      ///< ch: 轮廓模板匹配匹配极性参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_ANGLE_START           = 0x101000BA;      ///< ch: 轮廓模板匹配起始角度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_ANGLE_END             = 0x101000BB;      ///< ch: 轮廓模板匹配终止角度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SCALE_START           = 0x101000BC;      ///< ch: 轮廓模板匹配起始尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SCALE_END             = 0x101000BD;      ///< ch: 轮廓模板匹配终止尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SPOTTER_FLAG          = 0x101000BE;      ///< ch: 轮廓模板匹配噪点标记参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_MAX_OVERLAP           = 0x101000BF;      ///< ch: 轮廓模板匹配最大重叠率参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SCALE_X_START         = 0x101000C0;      ///< ch: 轮廓模板匹配X起始尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SCALE_X_END           = 0x101000C1;      ///< ch: 轮廓模板匹配X终止尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SCALE_Y_START         = 0x101000C2;      ///< ch: 轮廓模板匹配Y起始尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SCALE_Y_END           = 0x101000C3;      ///< ch: 轮廓模板匹配Y终止尺度参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_EXTENT_RATE           = 0x101000C4;      ///< ch: 轮廓模板匹配延拓阈值参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_ROUGH_FLAG            = 0x101000C5;      ///< ch: 轮廓模板匹配速度阈值开关参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_ROUGH_THD             = 0x101000C6;      ///< ch: 轮廓模板匹配速度阈值参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_SORT_TYPE             = 0x101000C7;      ///< ch: 轮廓模板匹配排序类型参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_TIME_OUT              = 0x101000C8;      ///< ch: 轮廓模板匹超时控制配参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_THD_FLAG              = 0x101000C9;      ///< ch: 轮廓模板匹配边缘阈值标志参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_THD                   = 0x101000CA;      ///< ch: 轮廓模板匹边缘阈值参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MATCH_IMPORTANCE_SCORE_TH   = 0x101000CB;      ///< ch: 轮廓模板匹配重要性得分阈值参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MODEL_MANUAL_CHAIN_LEN_FLAG = 0x101000CC;      ///< ch: 轮廓模板建模手动设置最小链长标识参数错误
const static int MVD_ALG_STS_ERR_MVBPATMATCH_PARAM_PYRAMID_MODEL_MIN_CHAIN_LEN         = 0x101000CD;      ///< ch: 轮廓模板建模最短链长阈值参数错误
...
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_TRAJ_POS_GUIDE_WRONG_POINTS                           =0x1010911C;  ///< ch: 无有效轨迹点输出
...
//表面缺陷滤波、分类器
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_KER_PARAM_OVERFLOW                              = 0x10113001;  ///< ch: 参数范围错误
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_KER_NUM_OVERFLOW                                = 0x10113002;  ///< ch: 参数范围错误
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_FILTER_RESPOND_OFFSET_OVERFLOW                  = 0x10113003;  ///< ch: 参数范围错误
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_SCRATCH_LINK_PARAM_OVERFLOW                     = 0x10113004;  ///< ch: 参数范围错误
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_SCREEN_OUT_PARAM_OVERFLOW                       = 0x10113005;  ///< ch: 参数范围错误
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_PARAM_ADJUST_FAILED                             = 0x10113006;  ///< ch: 参数范围错误
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_ROI_OVERFLOW                                    = 0x10113007;  ///< ch: 参数范围错误
const static int MVD_ALG_STS_ERR_MVB2D_FLAW_MODEL_PARAM_OVERFLOW                            = 0x10113008;  ///< ch: 参数范围错误
...
const static int MVD_ALG_STS_ERR_MVBCNN_CLASSIFY_ABILITY_ARG_MODU_ENABLE     = 0x10202004;      ///< ch: 算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CLASSIFY_ABILITY_ARG_MAX_IMAGE_SIZE  = 0x10202005;      ///< ch: 算法能力集最大图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CLASSIFY_ABILITY_ARG_MODEL_HANDEL    = 0x10202006;      ///< ch: 算法能力集模型句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CLASSIFY_ABILITY_ARG_CUDA_HANDLE     = 0x10202007;      ///< ch: 算法能力集CUDA句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CLASSIFY_ABILITY_ARG_THREAD_NUM      = 0x10202008;      ///< ch: 算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CLASSIFY_ABILITY_ARG_THREAD_HANDLE   = 0x10202009;      ///< ch: 算法能力集线程句柄参数错误
...
const static int MVD_ALG_STS_ERR_MVBCNN_DETECT_ABILITY_ARG_MODU_ENABLE      = 0x1020301B;      ///< ch: 算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_DETECT_ABILITY_ARG_MAX_IMAGE_SIZE   = 0x1020301C;      ///< ch: 算法能力集最大图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_DETECT_ABILITY_ARG_MODEL_HANDEL     = 0x1020301D;      ///< ch: 算法能力集模型句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_DETECT_ABILITY_ARG_CUDA_HANDLE      = 0x1020301E;      ///< ch: 算法能力集CUDA句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_DETECT_ABILITY_ARG_THREAD_NUM       = 0x1020301F;      ///< ch: 算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_DETECT_ABILITY_ARG_THREAD_HANDLE    = 0x10203020;      ///< ch: 算法能力集线程句柄参数错误
...
const static int MVD_ALG_STS_ERR_MVBCNN_CHAR_DETECT_ABILITY_ARG_MODU_ENABLE    = 0x10204027;      ///< ch: 算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CHAR_DETECT_ABILITY_ARG_MAX_IMAGE_SIZE = 0x10204028;      ///< ch: 算法能力集最大图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CHAR_DETECT_ABILITY_ARG_MODEL_HANDEL   = 0x10204029;      ///< ch: 算法能力集模型句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CHAR_DETECT_ABILITY_ARG_CUDA_HANDLE    = 0x1020402A;      ///< ch: 算法能力集CUDA句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CHAR_DETECT_ABILITY_ARG_THREAD_NUM     = 0x1020402B;      ///< ch: 算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CHAR_DETECT_ABILITY_ARG_THREAD_HANDLE  = 0x1020402C;      ///< ch: 算法能力集线程句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_CHAR_DETECT_ABILITY_ARG_PRC_TYPE       = 0x1020402D;      ///< ch: 算法能力集处理类型与模型类型不匹配
...
const static int MVD_ALG_STS_ERR_MVBOCRDL_ABILITY_ARG_MODU_ENABLE           = 0x10205012;      ///< ch: 算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBOCRDL_ABILITY_ARG_MAX_IMAGE_SIZE        = 0x10205013;      ///< ch: 算法能力集最大图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBOCRDL_ABILITY_ARG_MODEL_HANDEL          = 0x10205014;      ///< ch: 算法能力集模型句柄参数错误
const static int MVD_ALG_STS_ERR_MVBOCRDL_ABILITY_ARG_CUDA_HANDLE           = 0x10205015;      ///< ch: 算法能力集CUDA句柄参数错误
const static int MVD_ALG_STS_ERR_MVBOCRDL_ABILITY_ARG_THREAD_NUM            = 0x10205016;      ///< ch: 算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBOCRDL_ABILITY_ARG_THREAD_HANDLE         = 0x10205017;      ///< ch: 算法能力集线程句柄参数错误
...
const static int MVD_ALG_STS_ERR_MVBCNN_FLAW_ABILITY_ARG_MODU_ENABLE     = 0x1020600E;             ///< ch: 算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_FLAW_ABILITY_ARG_MAX_IMAGE_SIZE  = 0x1020600F;             ///< ch: 算法能力集图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_FLAW_ABILITY_ARG_CHANNLES        = 0x10206010;             ///< ch: 算法能力集通道个数参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_FLAW_ABILITY_ARG_MODEL_HANDLE    = 0x10206011;             ///< ch: 算法能力集模型句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_FLAW_ABILITY_ARG_CUDA_HANDLE     = 0x10206012;             ///< ch: 算法能力集CUDA句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_FLAW_ABILITY_ARG_THREAD_NUM      = 0x10206013;             ///< ch: 算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_FLAW_ABILITY_ARG_THREAD_HANDLE   = 0x10206014;             ///< ch: 算法能力集线程句柄参数错误
...
const static int MVD_ALG_STS_ERR_MVBCNN_RETRIEVAL_ABILITY_ARG_MODU_ENABLE       = 0x1020C00C;  ///< ch: 算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_RETRIEVAL_ABILITY_ARG_MAX_IMAGE_SIZE    = 0x1020C00D;  ///< ch: 算法能力集最大图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_RETRIEVAL_ABILITY_ARG_MODEL_HANDEL      = 0x1020C00E;  ///< ch: 算法能力集模型句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_RETRIEVAL_ABILITY_ARG_CUDA_HANDLE       = 0x1020C00F;  ///< ch: 算法能力集CUDA句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_RETRIEVAL_ABILITY_ARG_THREAD_NUM        = 0x1020C010;  ///< ch: 算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_RETRIEVAL_ABILITY_ARG_THREAD_HANDLE     = 0x1020C011;  ///< ch: 算法能力集线程句柄参数错误
...
// 异常检测
const static int MVD_ALG_STS_ERR_MVBCNN_INSPECT_ABILITY_ARG_MODU_ENABLE         = 0x1020E000;  ///< ch: 算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_INSPECT_ABILITY_ARG_MAX_IMAGE_SIZE      = 0x1020E001;  ///< ch: 算法能力集最大图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_INSPECT_ABILITY_ARG_MODEL_HANDEL        = 0x1020E002;  ///< ch: 算法能力集模型句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_INSPECT_ABILITY_ARG_CUDA_HANDLE         = 0x1020E003;  ///< ch: 算法能力集CUDA句柄参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_INSPECT_ABILITY_ARG_THREAD_NUM          = 0x1020E004;  ///< ch: 算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBCNN_INSPECT_ABILITY_ARG_THREAD_HANDLE       = 0x1020E005;  ///< ch: 算法能力集线程句柄参数错误
...
// 光伏串检类
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_LINE_DETECT_ERR             = 0x1010F001;   ///< ch: 直线检测失败
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_HOMO_WRONG                  = 0x1010F002;   ///< ch: 矩阵计算失败
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_WB_CNN_CLASSIFY             = 0x1010F003;   ///< ch: 露白检测CNN分类错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_EDGE_COUNT_NOT_ENOUGH       = 0x1010F004;   ///< ch: 边缘检测结果太少
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_COUNT_NOT_ENOUGH       = 0x1010F005;   ///< ch: 定位出的水平栅数量过少
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_VER_COUNT_NOT_ENOUGH        = 0x1010F006;   ///< ch: 定位出的竖直边缘数量过少
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_VER_EDGE_DETECT_ERR         = 0x1010F007;   ///< ch: 竖直边缘或边缘对定位失败
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_POINT_LOC_NUM_ERR           = 0x1010F008;   ///< ch: 定位到的拟合点过少
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CMP_FUNC_TYPE               = 0x1010F009;   ///< ch: 多边形建模回调函数类型错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CMP_CREATE_MODEL            = 0x1010F00a;   ///< ch: 多边形模板匹配建模错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CMP_ENABLE                  = 0x1010F00b;   ///< ch: 多边形建模使能标志位错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_IMG_CREATE_MODEL            = 0x1010F00c;   ///< ch: 主栅模板匹配建模错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CREATE_MODEL_CFG_NUM        = 0x1010F00d;   ///< ch: 建模模块回调函数个数错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CREATE_MODEL_FUNC_TYPE      = 0x1010F00e;   ///< ch: 建模模块回调函数类型错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CREATE_MODEL_ENABLE         = 0x1010F00f;   ///< ch: 建模模块使能标志位错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CREATE_MODEL_FIX_POINT      = 0x1010F010;   ///< ch: 建模模块基准点错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CREATE_MODEL_ROI_RECT       = 0x1010F011;   ///< ch: 建模模块ROI设置错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_FUNC_TYPE       = 0x1010F012;   ///< ch: 定位模块回调函数类型错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_ENABLE          = 0x1010F013;   ///< ch: 定位模块使能标志位错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_MODEL_NULL      = 0x1010F014;   ///< ch: 定位模块输入模型数据为空
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_MODE_SIZE_ERR   = 0x1010F015;   ///< ch: 定位模块模型大小错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_DP_ERR          = 0x1010F016;   ///< ch: 定位模块深度学习定位失败
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_CELL_MATCH_ERR  = 0x1010F017;   ///< ch: 定位模块片模板匹配失败
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_GRID_MATCH_ERR  = 0x1010F018;   ///< ch: 定位模块栅模板匹配失败
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_DETECT_CNN                  = 0x1010F019;   ///< ch: 正面目标检测CNN错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_TEMPLET_LOC_CELL_MATCH_NONE = 0x1010F01a;   ///< ch: 定位模块片模板匹配没匹配到
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CRACK_CNN_CLASSIFY          = 0x1010F01b;   ///< ch: 正面崩边CNN分类错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_STRING_LOC_ROI              = 0x1010F01c;   ///< ch: 串定位模块输入ROI错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_STRING_LOC_ROI_ENABLE       = 0x1010F01d;   ///< ch: 串定位模块输入ROI使能输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_PIECE_LOC_ROI               = 0x1010F01e;   ///< ch: 片定位模块输入ROI错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_LOC_ROI                = 0x1010F01f;   ///< ch: 栅定位模块输入ROI错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_LOC_CELL_NUM           = 0x1010F020;   ///< ch: 栅定位模块电池片数输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_LOC_GRID_NUM           = 0x1010F021;   ///< ch: 栅定位模块主栅数输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_LOC_CELL_MERGE_TYPE         = 0x1010F022;   ///< ch: 片、栅定位模块并片类型输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_LOC_INSPECT_TYPE            = 0x1010F023;   ///< ch: 片、栅定位模块检测类型(正面或反面)输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_LOC_STRING_EDGE_STRENGTH    = 0x1010F024;   ///< ch: 串定位模块边缘查找输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_LOC_STRING_IDEA_WIDTH       = 0x1010F025;   ///< ch: 串定位模块边缘查找理想宽度输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_PI_LOC_CELL_NUM             = 0x1010F026;   ///< ch: 正面片定位模块电池片数输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_NI_LOC_CELL_NUM             = 0x1010F027;   ///< ch: 背面片定位模块电池片数输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_PI_LOC_GRID_NUM             = 0x1010F028;   ///< ch: 正面栅定位模块栅个数输入错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_NI_LOC_GRID_NUM             = 0x1010F029;   ///< ch: 背面栅定位模块栅个数输入错误

const static int MVD_ALG_STS_ERR_MVBSOLARCELL_LINE_FIT_FAIL               = 0x1010F02A;   ///< ch: 直线拟合失败
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_ABILITY_ARG_MODU_ENABLE     = 0x1010F02B;   ///< ch: 光伏行业算法能力集模块使能参数错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_ABILITY_ARG_MAX_IMAGE_SIZE  = 0x1010F02C;   ///< ch: 光伏行业算法能力集图像宽高参数错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_ABILITY_ARG_MAX_IMAGE_NUM   = 0x1010F02D;   ///< ch: 光伏行业算法能力集最大图像个数参数错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_ABILITY_ARG_THREAD_NUM      = 0x1010F02E;   ///< ch: 光伏行业算法能力集线程数参数错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_ABILITY_ARG_THREAD_HANDLE   = 0x1010F02F;   ///< ch: 光伏行业算法能力集线程句柄参数错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_MAIN_GRID_LOC               = 0x1010F030;   ///< ch: 主栅定位错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_CELL_SIZE_MEASURE           = 0x1010F031;   ///< ch: 片尺寸测量错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_COARSE_CELL_LOC             = 0x1010F032;   ///< ch: 片初定位错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GAP_LINE_FIT_LOC            = 0x1010F033;   ///< ch: 间距检测直线拟合错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GAP_LINE_DETECT_LOC         = 0x1010F034;   ///< ch: 间距检测直线检测错误
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_BIAS_NULL_PTR          = 0x1010F040;   ///< ch: 传统焊带偏移输入存在空指针
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_BIAS_CELL_BOX          = 0x1010F041;   ///< ch: 传统焊带偏移输入片box参数异常
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_BIAS_GRID_LINE         = 0x1010F042;   ///< ch: 传统焊带偏移输入栅直线异常
const static int MVD_ALG_STS_ERR_MVBSOLARCELL_GRID_BIAS_GRID_NUM          = 0x1010F043;   ///< ch: 传统焊带偏移输入栅数量异常
