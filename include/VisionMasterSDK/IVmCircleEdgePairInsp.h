 ...
 * Note：CH: 圆弧对缺陷检测模块接口声明 | En: Interface for the CircleEdgePairInsp tool.
 *
 * Version：4.3
...
namespace VisionMasterSDK
{
    namespace IMVSCircleEdgePairInspModu
    {
        ...
        public:
            ...
            // CH: 输入圆弧1(仅当次执行起效) | EN: InputAnnulus1(Only valid for this execution)
            virtual void SetInputAnnulus1(Annulus* pInputValue, unsigned int nValueNum) = 0;

            // CH: 输入圆弧2(仅当次执行起效) | EN: InputAnnulus2(Only valid for this execution)
        ...
        */
        ...
        public:
             ...
             * 只读
             */
            /*  Note: Get the defect type of the Arc Pair inspect. */
             ...
             * 只读
             */
            /*  Note: Get the defect box of the Arc Pair inspect. */
             ...
             * 只读
             */
            /*  Note: Get the defect length of the Arc Pair inspect. */
             ...
             * 只读
             */
            /*  Note: Get the defect area of the Arc Pair inspect. */
        ...
        /*  Note: Interface Classes of the result of the CircleEdgePairInspResults.  */
