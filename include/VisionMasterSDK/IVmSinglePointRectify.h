/***************************************************************************************************
 * File：IVmSinglePointRectify.h
 * Note：CH: 单点纠偏模块接口声明 | En: Interface for the SinglePointRectify tool.
 *
 * Version：4.3
 * Date: 2021-01-13 14:43:42
 ***************************************************************************************************/
#ifndef _IVM_SINGLEPOINTRECTIFY_H_
#define _IVM_SINGLEPOINTRECTIFY_H_
...
{
    namespace SinglePointRectifyModu
    {
        /*************************** Params Class Start ***************************/
        ...
        /*  Note: Interface Classes of the parameter of the SinglePointRectifyParams.  */
        class SinglePointRectifyParams : public CModuParamsBase
        {
        protected:
            ///< Constructor and Destructor
            explicit SinglePointRectifyParams() {}
            virtual ~SinglePointRectifyParams() {}
        ...
        /*************************** Results Class Start ***************************/
        /*  Note: Interface Classes of the result of the SinglePointRectifyResults.  */
        class SinglePointRectifyResults : public CModuleResultBase
        {
        protected:
            ///< Constructor and Destructor
            explicit SinglePointRectifyResults() {}
            virtual ~SinglePointRectifyResults() {}
        ...
        /*************************** Tool Class Start ***************************/
        /*  Note: Note: This is the class for the SinglePointRectify tool.  */
        class SinglePointRectifyModuTool : public CVmToolBase
        {
        protected:
            ///< Constructor and Destructor
            explicit SinglePointRectifyModuTool() {}
            virtual ~SinglePointRectifyModuTool() {}
        ...
        public:
             ...
             * 通过参数对象可设置获取模块参数
             */
            virtual SinglePointRectifyParams* GetParamObj() = 0;
             ...
             * 只读
             */
            virtual SinglePointRectifyResults* GetResult() = 0;
        ...
        private:
            SinglePointRectifyModuTool(SinglePointRectifyModuTool&);
            SinglePointRectifyModuTool& operator=(SinglePointRectifyModuTool&);
        };
        /*************************** Tool Class End ***************************/
    }
}
...
/*  Note: Get tool instance for SinglePointRectify.  */
IMVS_6000_PLATFORMSDK_API VisionMasterSDK::SinglePointRectifyModu::SinglePointRectifyModuTool * __stdcall GetSinglePointRectifyToolInstance(IN const char * const strName);

#ifdef __cplusplus
}
#endif

#endif    ///< _IVM_SINGLEPOINTRECTIFY_H_
