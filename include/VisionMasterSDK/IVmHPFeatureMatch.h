/***************************************************************************************************
 * File：IVmHPFeatureMatch.h
 * Note：CH: 高精度特征匹配模块接口声明 | En: Interface for the HPFeatureMatch tool.
 *
 * Version：4.3
 * Date: 2021-01-13 14:43:42
 ***************************************************************************************************/
#ifndef _IVM_HPFEATUREMATCH_H_
#define _IVM_HPFEATUREMATCH_H_
...
{
    namespace IMVSHPFeatureMatchModu
    {
        /*************************** Params Class Start ***************************/
        ...
        class HPFeatureMatchRoiManager
        {
        public:
        ...
        /*  Note: Interface Classes of the parameter of the HPFeatureMatchParams.  */
        class HPFeatureMatchParams : public CModuParamsBase
        {
        protected:
            ///< Constructor and Destructor
            explicit HPFeatureMatchParams() {}
            virtual ~HPFeatureMatchParams() {}
        ...
        public:
            ...
            virtual HPFeatureMatchRoiManager* GetModuRoiManager() = 0;
        ...
        class IHPFeatureMatchInfo
        {
        protected:
            ///< Constructor and Destructor
            explicit IHPFeatureMatchInfo() {}
            virtual ~IHPFeatureMatchInfo() {}
        ...
        /*  Note: Interface Classes of the result of the HPFeatureMatchResults.  */
        class HPFeatureMatchResults : public CModuleResultBase
        {
        protected:
            ///< Constructor and Destructor
            explicit HPFeatureMatchResults() {}
            virtual ~HPFeatureMatchResults() {}
        ...
        public:
             ...
             * 无
             */
            virtual IHPFeatureMatchInfo* GetMatchInfo(int nMatchIndex) = 0;
            /**
             * @brief 获取匹配轮廓
             * @return 轮廓信息
             * @par 注解
        ...
        /*************************** Tool Class Start ***************************/
        /*  Note: Note: This is the class for the HPFeatureMatch tool.  */
        class IMVSHPFeatureMatchModuTool : public CVmToolBase
        {
        protected:
            ///< Constructor and Destructor
            explicit IMVSHPFeatureMatchModuTool() {}
            virtual ~IMVSHPFeatureMatchModuTool() {}
        ...
        public:
             ...
             * 通过参数对象可设置获取模块参数
             */
            virtual HPFeatureMatchParams* GetParamObj() = 0;
             ...
             * 只读
             */
            virtual HPFeatureMatchResults* GetResult() = 0;
        ...
        private:
            ...
            IMVSHPFeatureMatchModuTool& operator=(IMVSHPFeatureMatchModuTool&);
        };
        /*************************** Tool Class End ***************************/
    }
}
...
/*  Note: Get tool instance for HPFeatureMatch.  */
IMVS_6000_PLATFORMSDK_API VisionMasterSDK::IMVSHPFeatureMatchModu::IMVSHPFeatureMatchModuTool * __stdcall GetHPFeatureMatchToolInstance(IN const char * const strName);

#ifdef __cplusplus
}
#endif

#endif    ///< _IVM_HPFEATUREMATCH_H_
